...
const getWriterList = () => {
  ...
  writerList.push(HanziWriter.create('xu', '徐', NAME_CONFIG));
  writerList.push(HanziWriter.create('qin', '琴', NAME_CONFIG));
  // writerList.push(HanziWriter.create('qi', '我', NAME_CONFIG));
  return writerList;
}
